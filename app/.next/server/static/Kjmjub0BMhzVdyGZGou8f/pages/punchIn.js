...
/* harmony import */ var react_geocode__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("GNgB");
...
react_geocode__WEBPACK_IMPORTED_MODULE_16___default.a.setApiKey("AIzaSyC7jUeuFb_ujONIHAG-HKhyXggyd6hvz8s");
react_geocode__WEBPACK_IMPORTED_MODULE_16___default.a.setLanguage("zh-tw");
...
const TITLE = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.h1`
  ...
  text-align: center;
`;
const TEXT = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.h5`
  display: flex;
  color: #F8F9F9;
  font-family: Candara;
  text-align: center;
...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  getLocation() {
    try {
      ...
      navigator.geolocation.getCurrentPosition(function (position) {
        ...
        react_geocode__WEBPACK_IMPORTED_MODULE_16___default.a.fromLatLng(position.coords.latitude, position.coords.longitude).then(response => {
  ...
  getPunch() {
    try {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(URL_GETPUNCH, {
        method: 'get',
        headers: {
  ...
  render() {
    return __jsx("div", null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx("script", {
    ...
    }, "\u7C3D\u5230"))) : __jsx(BOX, null, __jsx(react_loader_spinner__WEBPACK_IMPORTED_MODULE_13___default.a, {
      type: "ThreeDots",
      color: "#f50057",
      height: 80,
      width: 80
