...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    ...
    }, __jsx(BOX, null, this.state.email && this.state.punch && this.state.address ? __jsx(_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_7___default.a, null, __jsx(TITLE, null, "\u73FE\u5728\u4F4D\u7F6E\uFF1A ", this.state.address), __jsx(BUTTON, {
      fontFamily: "Candara",
      variant: "contained",
      color: "secondary",
    ...
    }, "\u7C3D\u9000")) : __jsx(LOADERBOX, null, __jsx(react_loader_spinner__WEBPACK_IMPORTED_MODULE_13___default.a, {
      type: "ThreeDots",
      color: "#f50057",
      height: 80,
      width: 80
