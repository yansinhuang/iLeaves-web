...
const TITLE = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.h1`
  ...
  text-align: center;
`;
const TEXT = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.h4`
  display: flex;
  color: #191414;
  font-family: Candara;
  text-align: center;
...
const CONTAINER = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.div`
  ...
  align-items: center;
`;
const BUTTON = styled_components__WEBPACK_IMPORTED_MODULE_2___default()(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_4___default.a)`
&& {
  display: flex;
  variant: contained;
  width: 100%;
...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    ...
    }, __jsx(CONTAINER, null, this.state.email && this.state.punch && this.state.address ? __jsx("div", null, __jsx(BOX, null, __jsx(TITLE, null, " ", this.state.curTime, " ")), __jsx(BOX, null, __jsx(TEXT, null, "\u73FE\u5728\u4F4D\u7F6E\uFF1A ", this.state.address)), __jsx(BOX, null, __jsx(BUTTON, {
      fontFamily: "Candara",
      variant: "contained",
      color: "secondary",
    ...
    }, "\u7C3D\u5230"))) : __jsx(BOX, null, __jsx(react_loader_spinner__WEBPACK_IMPORTED_MODULE_7___default.a, {
      type: "ThreeDots",
      color: "#1DB954",
      height: 80,
      width: 80
