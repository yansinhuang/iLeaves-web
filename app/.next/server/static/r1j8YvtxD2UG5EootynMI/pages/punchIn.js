...
/* harmony import */ var react_geocode__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("GNgB");
/* harmony import */ var react_geocode__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(react_geocode__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("bW9D");
...
react_geocode__WEBPACK_IMPORTED_MODULE_9___default.a.setApiKey("AIzaSyC7jUeuFb_ujONIHAG-HKhyXggyd6hvz8s");
react_geocode__WEBPACK_IMPORTED_MODULE_9___default.a.setLanguage("zh-tw");
...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  liffInit() {
    try {
      liff.init(data => {
        ...
        isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()(URL_CHECKEXIST, {
          method: 'post',
          headers: {
  ...
  getLocation() {
    try {
      ...
      navigator.geolocation.getCurrentPosition(function (position) {
        ...
        react_geocode__WEBPACK_IMPORTED_MODULE_9___default.a.fromLatLng(position.coords.latitude, position.coords.longitude).then(response => {
  ...
  getPunch() {
    try {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()(URL_GETPUNCH, {
        method: 'get',
        headers: {
  ...
  createPunch() {
    try {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_3___default()(URL_CREATEPUNCH, {
        method: 'post',
        headers: {
          "Authorization": this.state.Authorization,
          "ubn": this.state.ubn,
  ...
  render() {
    return __jsx("div", null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_5___default.a, null, __jsx("script", {
    ...
    }, __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["CONTAINER"], null, this.state.email && this.state.punch && this.state.address ? __jsx("div", null, __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["BOX"], null, __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["TITLE"], null, " ", this.state.curTime, " ")), __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["BOX"], null, __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["TEXT"], null, "\u73FE\u5728\u4F4D\u7F6E\uFF1A ", this.state.address)), __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["BOX"], null, __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["BUTTON"], {
      fontFamily: "Candara",
      variant: "contained",
      color: "secondary",
    ...
    }, "\u7C3D\u5230"))) : __jsx(_component__WEBPACK_IMPORTED_MODULE_10__["BOX"], null, __jsx(react_loader_spinner__WEBPACK_IMPORTED_MODULE_7___default.a, {
      type: "ThreeDots",
      color: "#1DB954",
      height: 80,
      width: 80
