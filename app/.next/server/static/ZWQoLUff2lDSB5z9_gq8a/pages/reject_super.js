...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  render() {
    ...
    }, "\u9001\u51FA")) : this.state.userId && this.state.Authorization && this.state.ubn && this.state.leaveId && this.state.status == "signed" ? __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["MYFORM"], null, __jsx("label", null, "\u6B64\u5F35\u5047\u55AE\u5DF2\u7C3D\u6838")) : __jsx(LOADERBOX, null, __jsx(react_loader_spinner__WEBPACK_IMPORTED_MODULE_13___default.a, {
      type: "ThreeDots",
      color: "#f50057",
      height: 80,
      width: 80
