...
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__("pNaP");
...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__("bW9D");
...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  liffInit() {
    try {
      firebase__WEBPACK_IMPORTED_MODULE_16___default.a.initializeApp(config);
      liff.init(data => {
  ...
  forgotPassword(email) {
    try {
      firebase__WEBPACK_IMPORTED_MODULE_16___default.a.auth().sendPasswordResetEmail(email).then(function () {
        alert('請查看信箱：' + email);
        const messages = [{
          type: "text",
          text: "已發送密碼重設信"
  ...
  render() {
    return __jsx(_component__WEBPACK_IMPORTED_MODULE_17__["BOX"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx("script", {
    ...
    }, __jsx(_component__WEBPACK_IMPORTED_MODULE_17__["BOX"], null, this.state.email ? __jsx(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_6___default.a, {
      fontFamily: "Candara",
      variant: "contained",
      color: "secondary",
      onClick: () => {
    ...
    }, "\u767C\u9001\u5BC6\u78BC\u91CD\u8A2D\u4FE1") : __jsx(LOADERBOX, null, __jsx(react_loader_spinner__WEBPACK_IMPORTED_MODULE_13___default.a, {
      type: "ThreeDots",
      color: "#f50057",
      height: 80,
      width: 80
