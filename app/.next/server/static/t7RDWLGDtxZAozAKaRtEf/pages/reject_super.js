...
module.exports = __webpack_require__("BSEc");
...
class App extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  getQuery() {
    let urlParams = new URLSearchParams(global__WEBPACK_IMPORTED_MODULE_9___default.a.location.search);
  ...
  checkStatus(Authorization, ubn, id) {
    try {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(URL_GETLEAVE, {
        method: 'get',
        headers: {
  ...
  getStaff(Authorization, ubn, email) {
    try {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(URL_GETSTAFF, {
        method: 'get',
        headers: {
          "Authorization": Authorization
        }
  ...
  updateLeave(values) {
    try {
      ...
      isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_5___default()(URL_UPDATELEAVE, {
        method: 'post',
        headers: {
  ...
  render() {
    return __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["BOX"], null, __jsx(next_head__WEBPACK_IMPORTED_MODULE_8___default.a, null, __jsx("script", {
    ...
    }, __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["BOX"], null, __jsx(formik__WEBPACK_IMPORTED_MODULE_3__["Formik"], {
      initialValues: {
        rejectReason: ''
      },
      validate: values => {
      ...
      values,
      setFieldValue
    }) => __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["CONTAINER"], null, this.state.userId && this.state.Authorization && this.state.ubn && this.state.leaveId && this.state.status == "not signed" ? __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["MYFORM"], null, __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["FIELD"], {
      type: "rejectReason",
      name: "rejectReason",
      label: "\u62D2\u7D55\u539F\u56E0",
      component: formik_material_ui__WEBPACK_IMPORTED_MODULE_4__["TextField"]
    }), __jsx("br", null), __jsx("br", null), __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["BUTTON"], {
      type: "submit",
      fontFamily: "Candara",
      variant: "contained",
      color: "secondary",
      disabled: isSubmitting
    }, "\u9001\u51FA")) : this.state.userId && this.state.Authorization && this.state.ubn && this.state.leaveId && this.state.status == "signed" ? __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["MYFORM"], null, __jsx("label", null, "\u6B64\u5F35\u5047\u55AE\u5DF2\u7C3D\u6838")) : __jsx(_component__WEBPACK_IMPORTED_MODULE_15__["BOX"], null, __jsx(react_loader_spinner__WEBPACK_IMPORTED_MODULE_13___default.a, {
      type: "ThreeDots",
      color: "#1DB954",
      height: 80,
      width: 80
...
const BOX = styled_components__WEBPACK_IMPORTED_MODULE_0__["styled"].div`
  ...
  align-items: center;
`;
const TITLE = styled_components__WEBPACK_IMPORTED_MODULE_0__["styled"].h1`
  display: flex;  
  color: #191414;
  font-family: Candara;
  text-align: center;
`;
const TEXT = styled_components__WEBPACK_IMPORTED_MODULE_0__["styled"].h4`
  display: flex;
  color: #191414;
  font-family: Candara;
  text-align: center;
`;
const CONTAINER = styled_components__WEBPACK_IMPORTED_MODULE_0__["styled"].div`
  display: flex;
  height: 65vh;
  width: 75vw;
  padding: 30px;
  ...
  align-items: center;
`;
const BUTTON = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["styled"])(_material_ui_core_Button__WEBPACK_IMPORTED_MODULE_1___default.a)`
&& {
  display: flex;
  variant: contained;
  width: 100%;
...
`;
const MYFORM = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["styled"])(formik__WEBPACK_IMPORTED_MODULE_2__["Form"])`
  text-align: center;
  padding-top: 2em;
  padding-bottom: 2em;
`;
const FIELD = Object(styled_components__WEBPACK_IMPORTED_MODULE_0__["styled"])(formik__WEBPACK_IMPORTED_MODULE_2__["Field"])`
  width: 70vw;
  margin: auto;
`;
